...
export const formatData = async (data: { [key: number]: any }) => {
    ...
    return dataArray.map((item, index) => {
        ...
        status = handleCheckStatusDevice(item.sp, prevItem.mt, status, item.mt);
        ...
        return {
            ...
            distance: distance || null, // Distance (if calculated)
            total_distance: totalDistance, // Total traveled distance
